...
const CVButton = ({ title, href }) => {
  return (
    <a
      href={href}
      target="_blank"
      className="mt-6 flex flex-col items-center justify-center gap-2 rounded-md bg-light-300 py-2 px-3 text-sm font-semibold text-light-50 outline-offset-2 transition hover:bg-light-400 active:bg-zinc-800 active:text-zinc-100/70 active:transition-none dark:bg-dark-300 dark:hover:bg-zinc-900/80 dark:active:bg-zinc-700 dark:active:text-zinc-100/70"
    >
