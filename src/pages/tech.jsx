          ...
          <div className="space-y-20">
            <ToolsSection title="Frontend">
              <Tool title="Next.js">
                ...
                built in Next.js. It was also the main tech I worked with at
                both my LIA´s.
              </Tool>
              <Tool title="React.js">
              ...
              <Tool title="Typescript">
                Most of my React.js/Next.js projects are built with Typescript.
                It was also a "standard" at both my LIA's.
              </Tool>
            ...
            <ToolsSection title="Backend/Database">
              ...
              <Tool title="MongoDB (Mongoose.js)">
                I used MongoDB at my Master Thesis and a few other projects
                before that. This is the database I'm most comfortable with.
              </Tool>
              <Tool title="MySQL">
                Learned MySQL in the beginning of my education. Did one
                E-commerce project with it together with PHP.
              </Tool>
            </ToolsSection>
            <ToolsSection title="Other good things!">
              <Tool title="Stripe.js">
                Used Stripe.js at my Master Thesis and also another project
                before that. The parts I touched was "create customer", "create
                order", "payment" and "verification of payment"{' '}
              </Tool>
              <Tool title="Cypress.io">
                I learned Cypress at my LIA 1 very briefly. I can do simple
                tests
              </Tool>
