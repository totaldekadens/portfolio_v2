            ...
            <div className="lg:order-first lg:row-span-2">
              ...
              <div className="mt-6 text-base text-dark-200/80 dark:text-zinc-400">
                <p className="mb-8">
                  ...
                  "Oh crap, this happened and we need to fix it!" And with the
                  odds against us, ofc. I guess I got that from my soccer years.
                  My coach always told us. "It's not over until it's over, and a
                  lot can happen if you want to." Some people quit, I don't.
                ...
                <p className="mb-8">
                  ...
                  backend at the moment. I know I like to work with
                  functionality and problem solving (as mentioned), so I’ve been
                  drawn to eg admin pages within projects in school and been the
                  one ending up with creating the API’s.
                </p>
                <b className="dark:text-light-100">How I work?</b>
                <p className="mb-8">
                  When I go back and look at how it was at my previous
                  workplaces, I notice a pattern. I get a task or responsibility
                  and I end up being really good at it (Maybe not so Swedish of
                  me to say). I always want to get a good understanding of why I
                  do things and not just how to do it. It is very important to
                  me. As a co-worker I think I am perceived as very driven and
                  ambitious. I have also heard that I'm comfortable to be around
                  with. If someone wants a hug, I'm always there.
                </p>
                ...
                <p className="mb-8">
                  ...
                  help or brainstorming. Asking for help is neither a problem
                  for me. We do it together and we complement each other, that’s
                  my mindset.
                </p>{' '}
                <b className="dark:text-light-100">Leadership?</b>
                <p>
                  In total I have had a leadership role in almost 7 years. I
                  love being there for people and help them grow. My ambition is
                  not to be a leader again, but I think it’s a good thing to
                  mention about my past.
                </p>
              </div>
            </div>
